...
import com.jaydeep.blesample.operation.SettingsPages.SettingsFirstFragment;
...
int position;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootWiew=(ViewGroup) inflater.
                inflate(R.layout.main_settings_page,container
                        ,false);
        final TransationPage transationPage=new TransationPage();
        LinearLayout layout=(LinearLayout)rootWiew.findViewById(R.id.settingsLayout);
        ...
        SettingsFirstFragment settingsFirstFragment = new SettingsFirstFragment();
        fragmentTransaction.replace(R.id.frame_layoutSettings, settingsFirstFragment).commit();

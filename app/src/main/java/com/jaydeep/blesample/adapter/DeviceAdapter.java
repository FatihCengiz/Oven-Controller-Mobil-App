...
import com.jaydeep.blesample.operation.CharacteristicOperationFragment;
import com.jaydeep.blesample.operation.TransationPage;
        ...
        holder.btn_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mListener != null) {
                    ...
                    System.out.println("Device Adapter go to next");
